        ...
        if (file_exists($filePath)) {
            ...
            foreach ($lines as $line) {
                ...
                if (preg_match('/^([0-9]+)\s+(.*)$/', $line, $matches)) {
                    ...
                    if ($currentCode && !str_contains($line, 'Curso:') && !str_contains($line, 'CUADRO DE CLASIFICACIÓN') && !str_contains($line, 'Elaborado por:')) {
                        $accounts[$currentCode]['denominacion'] .= ' ' . $line;
                    }
                }
            }

            // Cuentas contables específicas obligatorias para el flujo de compras, ventas e IGV
            $requiredAccounts = [
                '101' => ['denominacion' => 'Caja', 'elemento' => 1],
                '1011' => ['denominacion' => 'Caja M/N', 'elemento' => 1],
                '104' => ['denominacion' => 'Cuentas corrientes en instituciones financieras', 'elemento' => 1],
                '10411' => ['denominacion' => 'Banco BCP M/N', 'elemento' => 1],
                '121' => ['denominacion' => 'Facturas, boletas y otros comprobantes por cobrar', 'elemento' => 1],
                '1212' => ['denominacion' => 'Facturas, boletas y otros comprobantes por cobrar - Emitidas en cartera', 'elemento' => 1],
                '201' => ['denominacion' => 'Mercaderías manufacturadas', 'elemento' => 2],
                '20111' => ['denominacion' => 'Mercaderías manufacturadas - Costo', 'elemento' => 2],
                '401' => ['denominacion' => 'Gobierno central', 'elemento' => 4],
                '4011' => ['denominacion' => 'Impuesto general a las ventas', 'elemento' => 4],
                '40111' => ['denominacion' => 'IGV - Cuenta propia', 'elemento' => 4],
                '421' => ['denominacion' => 'Facturas, boletas y otros comprobantes por pagar', 'elemento' => 4],
                '4212' => ['denominacion' => 'Facturas, boletas y otros comprobantes por pagar - Emitidas', 'elemento' => 4],
                '601' => ['denominacion' => 'Mercaderías', 'elemento' => 6],
                '6011' => ['denominacion' => 'Mercaderías manufacturadas', 'elemento' => 6],
                '611' => ['denominacion' => 'Mercaderías', 'elemento' => 6],
                '6111' => ['denominacion' => 'Mercaderías manufacturadas', 'elemento' => 6],
                '701' => ['denominacion' => 'Mercaderías', 'elemento' => 7],
                '70111' => ['denominacion' => 'Mercaderías - Venta local', 'elemento' => 7]
            ];
            ...
            try {
                ...
                DB::commit();
                echo "Plan de cuentas (PCGE) sembrado con éxito (" . count($accounts) . " cuentas).\n";
            } catch (\Exception $e) {
                DB::rollBack();
