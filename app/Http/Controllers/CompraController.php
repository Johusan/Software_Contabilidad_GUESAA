...
class CompraController extends Controller
{
    ...
    public function store(Request $request)
    {
        ...
        try {
            ...
            // Debe 401 (Gobierno Central / IGV) - IGV
            DetalleAsiento::create([
                'id_asiento' => $asiento->id_asiento,
                'codigo_cuenta' => '401',
                'debe' => $igv,
            ...
            // Haber 421 (Facturas, boletas y otros comprobantes por pagar) - Total
            DetalleAsiento::create([
                'id_asiento' => $asiento->id_asiento,
                'codigo_cuenta' => '421',
                'debe' => 0.00,
            ...
            // Haber 611 (Variación de existencias - Mercaderías) - Subtotal
            DetalleAsiento::create([
                'id_asiento' => $asientoDestino->id_asiento,
                'codigo_cuenta' => '611',
                'debe' => 0.00,
